            ...
            public boolean onCreateOptionsMenu (Menu menu){
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                        ...
                        if (i.equals("Kitchen")) {
                            Intent intent300 = new Intent(view.getContext(), kitchen.class);
                            startActivityForResult(intent300, 1);
                        }
                            if (i.equals("Bathroom")){
                                Intent intent302 = new Intent(view.getContext(), bathroom.class);
                                startActivityForResult(intent302,2);
                            }
                            if (i.equals("Living Room")){
                                Intent intent299 = new Intent(view.getContext(), livingroom.class);
                                startActivityForResult(intent299,3);
                            }
                            if (i.equals("Laundry Room")){
                                Intent intent301 = new Intent(view.getContext(), laundryroom.class);
                                startActivityForResult(intent301,4);
                            }
                            if (i.equals("Study Room")){
                                Intent intent302 = new Intent(view.getContext(), studyroom.class);
